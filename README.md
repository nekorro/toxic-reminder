...
- **Сейчас** — активная встреча (`▶ Сейчас: ЧЧ:ММ — Название`), если идёт; иначе
  «Нет активной встречи».
- **Далее** — ближайшая встреча (`Далее: ДД.ММ ЧЧ:ММ — Название`) или
  «Нет встреч следующие <lookahead_hours>h».
- Клик по строке встречи (текущей или следующей) открывает её видеоссылку.
  Строка кликабельна только если у встречи есть ссылка.
